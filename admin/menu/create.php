...
$pageTitle = 'Cloud 9 Cafe | Add Menu Item';
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($errors)) {
        try {
            $stmt = $pdo->prepare("INSERT INTO menu_items (name, description, category, price, image_path, is_available, created_by, created_at, updated_at) 
        ...
        <div class="admin-content">
            ...
            <div class="dashboard-card">
                <div class="card-header">
                    <h5 class="card-title">
                        <i class="bi bi-plus-circle me-2"></i>Item Information
                    </h5>
                </div>
                <div class="card-body">
